...
Mỗi chặng khép lại bằng một sản phẩm nộp được, trong đó chắc chắn sẽ có quyển chuyên đề với bố cục chuẩn, hoặc thêm vào nữa là một bài báo đăng tạp chí. Mình để mỗi chặng kết thúc bằng một sản phẩm cụ thể vì như vậy thì cả hai bên đều dễ theo dõi hơn. Cuối mỗi chặng, chỉ cần nhìn vào thứ bạn đang cầm trong tay là biết được mình đã đi tới đâu rồi.

::: {.note}
**Về bài báo khoa học.** Lộ trình hướng tới hai bài Scopus và một bài trong nước từ 0,75 điểm. Nhưng việc một bản thảo có được nhận đăng hay không thì ban biên tập và người phản biện quyết định, không phải mình, cũng không phải bạn. Điều mình hỗ trợ bạn được là làm cho bản thảo đủ chuẩn để nộp, và khi phản biện gửi về thì bạn có cách để trả lời.
:::
...
Chặng này để lại cho bạn một kỹ năng dùng được lâu dài, không chỉ cho một chuyên đề. Đọc có hệ thống thì phần tổng quan thường viết xong trong khoảng sáu tuần. Đọc theo cách gặp đâu đọc đó thì lâu hơn nhiều, và bản viết ra dễ nhận góp ý là mới dừng ở mức liệt kê.
...
- Trắc lượng thư mục bằng VOSviewer hoặc Bibliometrix trên R, nếu phù hợp với đề tài của bạn. Góc nhìn của mình về phương pháp này nằm ở [trang về mình](ve-nora.qmd)
...
### Mô hình đi ra từ lý thuyết nền, và bạn giải thích được vì sao từng đường dẫn có mặt ở đó

Đây là chỗ hội đồng hỏi nhiều nhất. Câu hỏi thường không dừng ở mô hình của bạn gồm những gì, mà đi tới vì sao lại chọn biến này, mối tương quan này lấy từ nguồn nào, và luận cứ đã đủ chưa.
...
Chặng dài nhất. Đây cũng là chỗ nhiều bạn phải quay lại làm thêm một vòng, vì dữ liệu thu về chưa dùng được, và nguyên nhân thường nằm ở bảng hỏi từ sáu tháng trước đó.

- Thiết kế nghiên cứu và chọn phương pháp phù hợp với câu hỏi, thay vì chọn theo thói quen, hoặc chọn chỉ vì một luận án trước đã làm như vậy
...
| Giữ nhịp tiến độ | Mình nhắc mốc tiến độ chủ động, không đợi bạn nhớ ra. Đây là phần nhiều bạn nói với mình là cần tới |
...
Đọc đúng và đọc đủ chừng đó thì khoảng trống nghiên cứu tự hiện ra, và bạn không còn phải ngồi đoán xem đề tài của mình có mới không. Đó là việc bạn cần làm xong ở chặng G1, và cũng là chỗ nhiều bạn ở lại lâu nhất, thường vì tập tài liệu chưa đủ rộng.
